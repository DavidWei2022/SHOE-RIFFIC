...
void resetScreen(int wCNT, int dCNT)
{
  ...
  lcd.setCursor(0,2); lcd.print("Dry: ");   lcd.setCursor(5,2); lcd.print("OFF"); lcd.setCursor(10,2); lcd.print("COUNT: "); lcd.setCursor(17, 2); lcd.print(wCNT);
  lcd.setCursor(0,3); lcd.print("Wash: ");  lcd.setCursor(6,3); lcd.print("OFF"); lcd.setCursor(11,2); lcd.print("COUNT: "); lcd.setCursor(17, 2); lcd.print(dCNT);
}